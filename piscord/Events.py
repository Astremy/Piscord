...
class Events:
    def __init__(self):
        ...
        class Event(BotElement):

            def __init__(self, bot, data):
                BotElement.__init__(self, data, bot)
                self.version = data["v"]
        ...
        class Event(Member):
            ...
            @Cache
            def message(self):
                return Message({**self.__bot.api(f"/channels/{self.channel_id}/messages/{self.message_id}"),
                                "guild_id": self.guild_id}, self.__bot)
        ...
        class Event(Invite):
            ...
            def __init__(self, bot, data):
                ...
                self.guild = bot.get_element(bot.guilds, id=self.guild_id)
                self.channel = bot.get_element(self.guild.channels, id=self.channel_id)
                for invite in self.channel.invites:
